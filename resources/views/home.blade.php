...
<body class="bg-pattern inset-0">
    <div class="container mx-auto px-6 py-12 text-center relative">
        <div class="bg-white shadow-lg rounded-lg overflow-hidden custom-top left-5 w-1/3 h-auto p-4 mt-10">
            <div class="relative z-10 px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div class="flex justify-center">
                    <a href="{{ route('login') }}" class="bg-pink-500 text-white font-bold py-2 px-4 rounded mr-4 hover:bg-pink-600">login</a>
                    <a href="{{ route('register') }}" class="bg-gray-800 text-white font-bold py-2 px-4 rounded hover:bg-gray-900">Registrar</a>
                </div>
            </div>
        </div>
    </div>
