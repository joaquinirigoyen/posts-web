                    ...
                    @foreach ($posts as $index => $post)
                        <div>
                            ...
                            <div
                                ...
                                <a href="{{ route('category.show', $post->idpost) }}"
                                    class="py-1 flex items-center justify-center w-full font-semibold rounded-md bg-white hover:bg-purple-500 hover:text-white transition-all duration-500 dark:bg-neutral-300 dark:hover:bg-purple-500 dark:hover:text-white ">Ver
